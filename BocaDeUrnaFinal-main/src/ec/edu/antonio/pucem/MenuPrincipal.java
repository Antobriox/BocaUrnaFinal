...
import ec.edu.dominios. pucem.Prefecto;
import ec.edu.formularios.pucem.BocaDeUrna;
import ec.edu.formularios.pucem.CrearPrefecto;
...
public class MenuPrincipal extends JFrame implements ActionListener {
	...
	public MenuPrincipal() {
		...
		contenedor.setBackground(new Color(192, 192, 192));
	...
	private void crearResultadosEnBarras() {
		...
		final JInternalFrame frame = new JInternalFrame("Estadistica en Barras", true);
	...
	private void crearResultadosEnPastel() {
		...
		final JInternalFrame frame = new JInternalFrame("Estadistuca en pastel", true);
